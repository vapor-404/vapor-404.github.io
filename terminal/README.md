...
If you do add a function, you also have to put its name in the hookCommands list, which is also in bin.js. A few of them are weird and should be in term.js (like reddit and 4chan) because they intercept the text entry earlier, and those commands just print their usage.
